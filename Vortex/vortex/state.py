# State manager — in-memory implementation (swap for Redis later)
...
class StateManager:
    ...
    def mark_agent_running(self, run_id: str, agent_name: str) -> None:
    ...
    def mark_agent_completed(
        self, run_id: str, agent_name: str, output: dict[str, Any], retry_count: int = 0
    ) -> None:
        run = self._runs[run_id]
        agent = run.agents[agent_name]
